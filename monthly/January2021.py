...
def app():
    ...
    with soldPerHourColumn:
        fg_sales = df.groupby(by=["Productos"]).sum()[["Hora 13" , "Hora 14" , "Hora 15" , "Hora 16" , "Hora 17" ,"Hora 18" , "Hora 19" , "Hora 20" , "Hora 21" , "Hora 22" , "Hora 23"]]

        sales_hour = px.bar(
                fg_sales,
                x=fg_sales.index,
                y=["Hora 13" , "Hora 14" , "Hora 15" , "Hora 16" , "Hora 17" ,"Hora 18" , "Hora 19" , "Hora 20" , "Hora 21" , "Hora 22" , "Hora 23"],
